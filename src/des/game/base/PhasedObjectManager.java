 ...
 */
public class PhasedObjectManager extends ObjectManager<PhasedObject> {
    ...
    @Override
    public void add(PhasedObject object) {
    ...
    public PhasedObject find(int phase) {
    ...
    private static class PhasedObjectComparator implements Comparator<PhasedObject>  {
        public int compare(PhasedObject object1, PhasedObject object2) {
            int result = 0;
            if (object1 != null && object2 != null) {
                result = ( object1).phase - ( object2).phase;
