...
public class LinearRate extends FieldBehavior{
	 ...
	 * @param location
	 */
	public LinearRate(double magnitude, Boundary area,GLPoint location){
	...
	public boolean handleObject(PhysicsObject object){
		...
		if(object.getVector()!=null){
			...
			if(flag){
				...
				double distance = Math.sqrt((fx-vx)*(fx-vx) + (fy-vy)*(fy-vy));
