...
public class GameThread implements Runnable {
    ...
    public static int curretFPS = 0;
    
    private static final long PROFILE_REPORT_DELAY = 3000l;
        ...
        while (!mFinished) {
            if (mGameRoot != null) {
                ...
                if (timeDelta > 12) {
                    ...
                    finalDelta = endTime - tempLastTime;//time;
                    //DebugLog.d("draw2", "finalDelta: " + finalDelta + " seconds delta: " + secondsDelta );
                    mProfileTime += finalDelta;
                    mProfileFrames++;
                    if (mProfileTime > PROFILE_REPORT_DELAY) {
                        final long averageFrameTime = mProfileTime / mProfileFrames;
                        DebugLog.d("draw", "Average: " + averageFrameTime + " pt: " + mProfileTime + " pf: " + mProfileFrames + " clock: " + SystemClock.uptimeMillis());
