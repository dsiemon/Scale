...
public class InputSystem extends BaseObject {
	...
	private InputScreen screen = new InputScreen();
    ...
    public void touchDown(int index, float x, float y) {
	   ...
	   screen.press(index, time.getGameTime(), x, params.gameHeight - y); 
    }
    ...
    public void touchUp(int index, float x, float y) {
 	   ...
 	   screen.release(index, time.getGameTime(), x, params.gameHeight - y);
